...
echo "[debug] reward_model.use_reward_loop=False"
echo "[debug] reward_manager.source=register"
echo "[debug] reward_manager.name=batch"
echo "[debug] custom_reward_function.path=/nfsdata-117/project/finvlr1/zlf/guotai-reward/verl/reward-zlf/reward/natural_feedback_reward.py"
echo "[debug] custom_reward_function.name=compute_score_batch"
...
# Load LLM credentials/config from .env and export to subprocesses (works with KEY="value" format)
set -a
source /nfsdata-117/project/finvlr1/zlf/guotai-reward/verl/reward-zlf/reward/.env
set +a
...
export NATURAL_FEEDBACK_LLM_DEBUG=1
export NATURAL_FEEDBACK_LLM_ERROR_LOG_INTERVAL=1
...
python3 -m verl.trainer.main_ppo \
    ...
    custom_reward_function.path=/nfsdata-117/project/finvlr1/zlf/guotai-reward/verl/reward-zlf/reward/natural_feedback_reward.py \
    ...
    trainer.default_local_dir=/nfsdata-117/project/finvlr1/zlf/guotai-reward/verl/reward-zlf/checkpoints/testv3 \
    ...
    +reward_model.reward_kwargs.process_similarity_threshold=0.5 \
    trainer.critic_warmup=0.05 \
    trainer.logger='["console","swanlab"]' \
    trainer.project_name='guotai-verl' \
    trainer.experiment_name='test-grpo-4b-ins-5k-v3' \
