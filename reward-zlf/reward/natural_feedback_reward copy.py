...
LLM_MAX_TOKENS: int = int(os.environ.get("NATURAL_FEEDBACK_LLM_MAX_TOKENS", "4096"))
LLM_REQUEST_TIMEOUT: float = float(os.environ.get("NATURAL_FEEDBACK_LLM_REQUEST_TIMEOUT", os.environ.get("NATURAL_FEEDBACK_LLM_TIMEOUT_S", "30.0")))
...
LLM_MAX_CONCURRENT_REQUESTS: int = int(os.environ.get("NATURAL_FEEDBACK_LLM_MAX_CONCURRENT_REQUESTS", "100"))
...
class NaturalFeedbackRewardManager(AbstractRewardManager):
    ...
    def __call__(self, data: DataProto, return_dict: bool = False):
        ...
        for i in range(len(response_ids)):
            ...
            # 分项
            r_format = -1.0 if not format_ok else 0.0
            r_outcome = 0.0
            r_process = 0.0
            f1_score = 0.0
            p_score = 0.0
